      ...
      {!tab1Content && (
        <div className="mt-6 bg-yellow-50 rounded-lg p-4 border border-yellow-200">
          <div className="flex items-center">
            ...
            <div>
              <h4 className="font-medium text-yellow-800">AI包括分析が未実行です</h4>
              <p className="text-sm text-yellow-700 mt-1">
                Step4で「最終AI分析を開始」ボタンをクリックすると、より詳細な分析結果が表示されます。
              </p>
            </div>
          </div>
        </div>
      ...
      {tab1Content && (
        <div className="mt-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6 border border-blue-200">
          <div className="flex items-center mb-4">
            ...
            <h4 className="text-lg font-bold text-blue-900">AI包括分析結果</h4>
      ...
      {tab2Content && (
        <div className="mt-6 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg p-6 border border-purple-200">
          <div className="flex items-center mb-4">
            ...
            <h4 className="text-lg font-bold text-purple-900">AI包括分析結果</h4>
      ...
      {tab3Content && (
        <div className="mt-6 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg p-6 border border-green-200">
          <div className="flex items-center mb-4">
            ...
            <h4 className="text-lg font-bold text-green-900">AI包括分析結果</h4>
